...
import img from "images/elearning2.png"
...
const ImageColumn = tw(Column)`ml-auto lg:mr-0 relative mt-12 lg:mt-0 lg:ml-32`;
...
`;
const Testimonial = tw.div`max-w-sm rounded-b md:rounded-none relative sm:absolute bottom-0 inset-x-0 z-20 px-8 py-6 sm:px-10 sm:py-8 bg-primary-900 text-gray-400 font-medium transform md:-translate-x-32 text-sm leading-relaxed md:-mr-16 xl:mr-0 mt-8`; // Added mt-8 for margin-top
...
export default ({
  heading = "Enhance your team's skills with our e-learning platform.",
  description = "Our platform offers tailored courses to help employees enhance their professional skills in areas like technology, management, and more.",
  ...
  buttonRounded = true,
  features = ["Interactive Learning Modules", "User-Friendly Interface ", "Real-Time Progress Tracking"],
  testimonial = {
    quote: "Thanks to this platform, our employees improved their skills efficiently and quickly.",
    // customerName: "Charlotte Hale",
    customerCompany: "Skill Forge"
  }
}) => {

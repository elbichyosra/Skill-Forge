...
const Heading = tw.h1`w-full text-center`;
...
const Text = tw.span`text-lg lg:text-xl font-semibold`;
...
const FileTypeIcon = tw.span`mr-2 h-6 w-6`;
                  ...
                  {activeTitleIndex !== null ? (
                    <File>
                      ...
                      {mediaMaterials[activeTitleIndex].file.includes('.pdf') ? (
                        ...
                        <FileMedia>
                          <video controls src={`http://localhost:5000/${mediaMaterials[activeTitleIndex].file}`} className="img-fluid rounded" style={{ maxHeight: '300px', width: '100%' }} />
                        </FileMedia>
                      ) : null}
                          <div>
